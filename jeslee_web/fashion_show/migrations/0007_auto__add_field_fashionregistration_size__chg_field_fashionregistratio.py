...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FashionRegistration.size'
        db.add_column(u'fashion_show_fashionregistration', 'size',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.ClothingSize'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'FashionRegistration.birth_date'
        db.alter_column(u'fashion_show_fashionregistration', 'birth_date', self.gf('django.db.models.fields.DateField')(max_length=10, null=True))

    def backwards(self, orm):
        # Deleting field 'FashionRegistration.size'
        db.delete_column(u'fashion_show_fashionregistration', 'size_id')


        # Changing field 'FashionRegistration.birth_date'
        db.alter_column(u'fashion_show_fashionregistration', 'birth_date', self.gf('django.db.models.fields.DateField')(default='', max_length=10))
