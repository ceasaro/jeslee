...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FashionShow.cancelled'
        db.add_column(u'fashion_show_fashionshow', 'cancelled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FashionShow.cancelled'
        db.delete_column(u'fashion_show_fashionshow', 'cancelled')
