...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FashionShow.participate'
        db.add_column(u'fashion_show_fashionshow', 'participate',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FashionShow.participate'
        db.delete_column(u'fashion_show_fashionshow', 'participate')
    ...
    models = {
        ...
        u'fashion_show.fashionshow': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'participate': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
