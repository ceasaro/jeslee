...
from jeslee_web.fashion_show.views import FashionRegistrationCreateView, FashionRegistrationDetailView, FashionShowsView

__author__ = 'ceasaro'
urlpatterns = patterns(
    'jeslee_web.fashion_show',
    url(r'^$', FashionShowsView.as_view(template_name='fashion_show/fashion_shows.html'),
        name='modeshows'),
